    ...
    H264_SLICE_HEADER_PARAMS *pSlHParams)
{
    ...
    if (pSlHParams->SliceFrame_Type==SLHP_IDR_SLICEFRAME_TYPE)
        lnc__write_upto8bits_elements(mtx_hdr, elt_p, 1, 1);/* idr_pic_id ue(v) = 0 (1b) in Topaz */
    ...
    if (pSlHParams->SliceFrame_Type==SLHP_IDR_SLICEFRAME_TYPE)
    {
        ...
        lnc__write_upto8bits_elements(mtx_hdr, elt_p, 0, 1);/* long_term_reference_flag (1 bit) = 0 */
    }
    else
    {
    ...
    H264_SLICE_HEADER_PARAMS *pSlHParams)
{
    ...
    lnc__H264_writebits_slice_header1(mtx_hdr, elt_p, pSlHParams);
    ...
    IMG_UINT8 MB_No_In_Slice)
{
     ...
     */
    lnc__H264_writebits_slice_header(mtx_hdr, elt_p, pSlHParams);
	...
	IMG_UINT32 ui_need_idr)
{
    ...
    if(uiMBSkipRun)
        ...
        lnc__H264_getelements_slice_header(mtx_hdr, &SlHParams);
}
