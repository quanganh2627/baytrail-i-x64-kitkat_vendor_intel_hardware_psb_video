/*
	Register defines for TOPAZHP_
	Command line: -chipname TOPAZHP C:/work/TopazHP/3.4_Build151/sim/topaz/topaz_reg_defs/topazhp_core_regs.def -simout topazhp_core_regs.h
	Generated by regconv version 1.158, from files:
	topazhp_core_regs.def 
*/
...
/* Register CR_LRITC_TILE_FREE_STATUS */
#define TOPAZHP_CR_LRITC_TILE_FREE_STATUS 0x004C
#define MASK_TOPAZHP_CR_FREE_TILES  0x0000003F
#define SHIFT_TOPAZHP_CR_FREE_TILES 0
#define REGNUM_TOPAZHP_CR_FREE_TILES 0x004C
#define SIGNED_TOPAZHP_CR_FREE_TILES 0

#define MASK_TOPAZHP_CR_REALLOCATABLE_TILES 0x00003F00
#define SHIFT_TOPAZHP_CR_REALLOCATABLE_TILES 8
#define REGNUM_TOPAZHP_CR_REALLOCATABLE_TILES 0x004C
#define SIGNED_TOPAZHP_CR_REALLOCATABLE_TILES 0
...
/* Register CR_LRITC_CACHE_CHUNK_STATUS */
#define TOPAZHP_CR_LRITC_CACHE_CHUNK_STATUS 0x0054
#define MASK_TOPAZHP_CR_CACHE_REQUEST_COUNT 0x000000FF
#define SHIFT_TOPAZHP_CR_CACHE_REQUEST_COUNT 0
#define REGNUM_TOPAZHP_CR_CACHE_REQUEST_COUNT 0x0054
#define SIGNED_TOPAZHP_CR_CACHE_REQUEST_COUNT 0
...
#define MASK_TOPAZHP_CR_CARC_ENABLE 0x00100000
#define SHIFT_TOPAZHP_CR_CARC_ENABLE 20
#define REGNUM_TOPAZHP_CR_CARC_ENABLE 0x0154
#define SIGNED_TOPAZHP_CR_CARC_ENABLE 0
#define TOPAZHP_CR_CARC_ENABLE_CARC_ON		0x00000001		/* CARC is enabled */
#define TOPAZHP_CR_CARC_ENABLE_CARC_OFF		0x00000000		/* CARC is disabled */
...
/* Register CR_H264COMP_REJECT_THRESHOLD */
#define TOPAZHP_CR_H264COMP_REJECT_THRESHOLD 0x0184
#define MASK_TOPAZHP_CR_H264COMP_4X4_REJECT_THRSHLD 0x0000001F
#define SHIFT_TOPAZHP_CR_H264COMP_4X4_REJECT_THRSHLD 0
#define REGNUM_TOPAZHP_CR_H264COMP_4X4_REJECT_THRSHLD 0x0184
#define SIGNED_TOPAZHP_CR_H264COMP_4X4_REJECT_THRSHLD 0

#define MASK_TOPAZHP_CR_H264COMP_8X8_REJECT_THRSHLD 0x00003F00
#define SHIFT_TOPAZHP_CR_H264COMP_8X8_REJECT_THRSHLD 8
#define REGNUM_TOPAZHP_CR_H264COMP_8X8_REJECT_THRSHLD 0x0184
#define SIGNED_TOPAZHP_CR_H264COMP_8X8_REJECT_THRSHLD 0
...
#define TOPAZHP_CR_SPE_ZERO_THRESH  0x0344
#define MASK_TOPAZHP_CR_SPE_ZERO_THRESH 0x0000001F
#define SHIFT_TOPAZHP_CR_SPE_ZERO_THRESH 0
#define REGNUM_TOPAZHP_CR_SPE_ZERO_THRESH 0x0344
#define SIGNED_TOPAZHP_CR_SPE_ZERO_THRESH 0
...
#define TOPAZHP_REG_DEFAULT_TABLE struct {\
	...
	{0x0000, 0x00000000, 0x000001FF, 0, "CR_TOPAZHP_SRST" } ,\
	{0x0004, 0x00000000, 0xE0017FFF, 0, "CR_TOPAZHP_INTSTAT" } ,\
	{0x0008, 0x00000000, 0x60017FFF, 0, "CR_TOPAZHP_MTX_INTENAB" } ,\
	{0x000C, 0x00000000, 0xA0017FFF, 0, "CR_TOPAZHP_HOST_INTENAB" } ,\
	{0x0010, 0x00000000, 0x00017FFF, 0, "CR_TOPAZHP_INTCLEAR" } ,\
	{0x0014, 0x00000000, 0x00017FFF, 0, "CR_TOPAZHP_INT_COMB_SEL" } ,\
	{0x0018, 0x00000200, 0x0000FFFF, 1, "CR_TOPAZHP_BUSY" } ,\
	{0x0024, 0x00000000, 0x00003EFF, 0, "CR_TOPAZHP_AUTO_CLOCK_GATING" } ,\
	{0x0028, 0x00000000, 0x00007FFF, 0, "CR_TOPAZHP_MAN_CLOCK_GATING" } ,\
	{0x002C, 0x0640FFFF, 0x0FFFFFFF, 0, "CR_TOPAZHP_REQ_PRIORITY" } ,\
	{0x0030, 0x00003468, 0x00003FFF, 0, "CR_TOPAZHP_RTM" } ,\
	{0x0034, 0x00000000, 0x0000FFFF, 1, "CR_TOPAZHP_RTM_VALUE" } ,\
	{0x0038, 0x00000000, 0x0000FFFF, 0, "CR_TOPAZHP_MB_PERFORMANCE_RESULT" } ,\
	{0x003C, 0x00000000, 0x0000FFFF, 0, "CR_TOPAZHP_MB_PERFORMANCE_MB_NUMBER" } ,\
	{0x0040, 0x00000000, 0x3F3F3F3F, 0, "CR_LRITC_TILE_USE_CONFIG" } ,\
	{0x0048, 0x00000000, 0x3F3F3F3F, 1, "CR_LRITC_TILE_USE_STATUS" } ,\
	{0x004C, 0x00000020, 0x00003F3F, 1, "CR_LRITC_TILE_FREE_STATUS" } ,\
	{0x0050, 0x0040A060, 0x00FFFFFF, 0, "CR_LRITC_CACHE_CHUNK_CONFIG" } ,\
	{0x0054, 0x00000000, 0x000000FF, 1, "CR_LRITC_CACHE_CHUNK_STATUS" } ,\
	{0x0058, 0x00000000, 0xFFFFFFFF, 0, "CR_LRITC_SIGNATURE_ADDR" } ,\
	{0x005C, 0x00000000, 0xFFFFFFFF, 0, "CR_LRITC_SIGNATURE_RDATA" } ,\
	{0x0060, 0x00000000, 0x003F1F1F, 0, "CR_MEM_SIGNATURE_CONTROL" } ,\
	{0x0064, 0x00000000, 0xFFFFFFFF, 0, "CR_MEM_SIGNATURE_ENC_WDATA" } ,\
	{0x0068, 0x00000000, 0xFFFFFFFF, 0, "CR_MEM_SIGNATURE_ENC_RDATA" } ,\
	{0x006C, 0x00000000, 0xFFFFFFFF, 0, "CR_MEM_SIGNATURE_ENC_ADDR" } ,\
	{0x0070, 0x00000000, 0xFFFFFFFF, 0, "CR_PREFETCH_LRITC_SIGNATURE" } ,\
	{0x00E0, 0x00000000, 0x03FFFF07, 0, "CR_PROC_DMA_CONTROL" } ,\
	{0x00E4, 0x00000000, 0x03FFFF07, 1, "CR_PROC_DMA_STATUS" } ,\
	{0x00EC, 0x00000000, 0x03033FF0, 0, "CR_PROC_ESB_ACCESS_CONTROL" } ,\
	{0x00F0, 0x00000000, 0xFFFFFFFF, 0, "CR_PROC_ESB_ACCESS_WORD0" } ,\
	{0x00F4, 0x00000000, 0xFFFFFFFF, 0, "CR_PROC_ESB_ACCESS_WORD1" } ,\
	{0x00F8, 0x00000000, 0xFFFFFFFF, 0, "CR_PROC_ESB_ACCESS_WORD2" } ,\
	{0x00FC, 0x00000000, 0xFFFFFFFF, 0, "CR_PROC_ESB_ACCESS_WORD3" } ,\
	{0x0100, 0x00000000, 0xFFFFFFF0, 0, "CR_SEQ_CUR_PIC_LUMA_BASE_ADDR" } ,\
	{0x0104, 0x00000000, 0xFFFFFFF0, 0, "CR_SEQ_CUR_PIC_CB_BASE_ADDR" } ,\
	{0x0108, 0x00000000, 0xFFFFFFF0, 0, "CR_SEQ_CUR_PIC_CR_BASE_ADDR" } ,\
	{0x010C, 0x00000000, 0xFFC0FFC0, 0, "CR_SEQ_CUR_PIC_ROW_STRIDE" } ,\
	{0x0110, 0x00000000, 0xFFFFFF00, 0, "CR_SEQ_REF_PIC0_LUMA_BASE_ADDR" } ,\
	{0x0114, 0x00000000, 0xFFFFFF00, 0, "CR_SEQ_REF_PIC0_CHROMA_BASE_ADDR" } ,\
	{0x0118, 0x00000000, 0xFFFFFF00, 0, "CR_SEQ_REF_PIC1_LUMA_BASE_ADDR" } ,\
	{0x011C, 0x00000000, 0xFFFFFF00, 0, "CR_SEQ_REF_PIC1_CHROMA_BASE_ADDR" } ,\
	{0x0120, 0x00000000, 0x00000071, 0, "CR_SEQ_CUR_PIC_CONFIG" } ,\
	{0x0124, 0x00000000, 0x00FF00FF, 0, "CR_SEQ_CUR_PIC_SIZE" } ,\
	{0x0128, 0x00000000, 0xFFFFFF00, 0, "CR_SEQ_RECON_LUMA_BASE_ADDR" } ,\
	{0x012C, 0x00000000, 0xFFFFFF00, 0, "CR_SEQ_RECON_CHROMA_BASE_ADDR" } ,\
	{0x0130, 0x00000000, 0xFFFFFFC0, 0, "CR_SEQ_ABOVE_PARAM_BASE_ADDR" } ,\
	{0x0134, 0x00000000, 0xFFFFFFC0, 0, "CR_SEQ_TEMPORAL_COLOCATED_IN_ADDR" } ,\
	{0x0138, 0x00000000, 0xFFFFFFC0, 0, "CR_SEQ_TEMPORAL_PIC0_MV_IN_ADDR" } ,\
	{0x013C, 0x00000000, 0xFFFFFFC0, 0, "CR_SEQ_TEMPORAL_PIC1_MV_IN_ADDR" } ,\
	{0x0140, 0x00000000, 0xFFFFFFC0, 0, "CR_SEQ_TEMPORAL_COLOCATED_OUT_ADDR" } ,\
	{0x0144, 0x00000000, 0xFFFFFFC0, 0, "CR_SEQ_TEMPORAL_PIC0_MV_OUT_ADDR" } ,\
	{0x0148, 0x00000000, 0xFFFFFFC0, 0, "CR_SEQ_TEMPORAL_PIC1_MV_OUT_ADDR" } ,\
	{0x014C, 0x00000000, 0xFFFFFFC0, 0, "CR_SEQ_MB_FIRST_STAGE_OUT_ADDR" } ,\
	{0x0150, 0x00000000, 0xFFFFFFC0, 0, "CR_SEQ_MB_CONTROL_IN_ADDR" } ,\
	{0x0154, 0x00000000, 0x7FFFFFF7, 0, "CR_SEQUENCER_CONFIG" } ,\
	{0x0158, 0x00000000, 0x0003FF00, 0, "CR_SLICE_CONFIG" } ,\
	{0x015C, 0x00000000, 0x0000033F, 0, "CR_SLICE_QP_CONFIG" } ,\
	{0x0160, 0x00000000, 0x37FFFFFF, 0, "CR_SEQUENCER_KICK" } ,\
	{0x0164, 0x00000000, 0x3FFFFFFF, 1, "CR_SEQUENCER_STATUS" } ,\
	{0x0168, 0x00000000, 0xFFFFFFC0, 0, "CR_SEQ_BEST_MULTIPASS_OUT_ADDR" } ,\
	{0x016C, 0x00000000, 0x0003FF00, 0, "CR_MVCLIP_CONFIG" } ,\
	{0x0170, 0x00040303, 0xFF8F0F0F, 0, "CR_MVCALC_CONFIG" } ,\
	{0x0174, 0x00000100, 0x000007FF, 0, "CR_MVCALC_COLOCATED" } ,\
	{0x0178, 0x01000100, 0x07FF07FF, 0, "CR_MVCALC_BELOW" } ,\
	{0x017C, 0x00000000, 0x0000773F, 0, "CR_PREFETCH_QP" } ,\
	{0x0180, 0x00000000, 0x00000007, 0, "CR_MB_HOST_CONTROL" } ,\
	{0x0184, 0x00000000, 0x00003F1F, 0, "CR_H264COMP_REJECT_THRESHOLD" } ,\
	{0x0188, 0x00000000, 0x00000007, 0, "CR_FIELD_PARITY" } ,\
	{0x01A0, 0x00000000, 0x3FFF3FFF, 0, "CR_H264COMP_CUSTOM_QUANT_SP" } ,\
	{0x01A4, 0x00000000, 0x7F7F7F7F, 0, "CR_H264COMP_CUSTOM_QUANT_Q" } ,\
	{0x01A8, 0x00000000, 0x00037FBF, 0, "CR_H264COMP_CONTROL" } ,\
	{0x01AC, 0x0003FFFF, 0x0003FFFF, 0, "CR_H264COMP_INTRA_PRED_MODES" } ,\
	{0x01B0, 0x00000000, 0x0000FFFF, 0, "CR_H264COMP_MAX_CYCLE_COUNT" } ,\
	{0x01B4, 0x00000000, 0x3000FFFF, 0, "CR_H264COMP_MAX_CYCLE_MB" } ,\
	{0x01B8, 0x00000000, 0x00000003, 0, "CR_H264COMP_MAX_CYCLE_RESET" } ,\
	{0x01BC, 0x00000000, 0xFFFFFFFF, 0, "CR_H264COMP4X4_PRED_CRC" } ,\
	{0x01C0, 0x00000000, 0xFFFFFFFF, 0, "CR_H264COMP4X4_COEFFS_CRC" } ,\
	{0x01C4, 0x00000000, 0xFFFFFFFF, 0, "CR_H264COMP4X4_RECON_CRC" } ,\
	{0x01C8, 0x00000000, 0xFFFFFFFF, 0, "CR_H264COMP8X8_PRED_CRC" } ,\
	{0x01CC, 0x00000000, 0xFFFFFFFF, 0, "CR_H264COMP8X8_COEFFS_CRC" } ,\
	{0x01D0, 0x00000000, 0xFFFFFFFF, 0, "CR_H264COMP8X8_RECON_CRC" } ,\
	{0x01D4, 0x00000000, 0xFFFFFFFF, 0, "CR_H264COMP16X16_PRED_CRC" } ,\
	{0x01D8, 0x00000000, 0xFFFFFFFF, 0, "CR_H264COMP16X16_COEFFS_CRC" } ,\
	{0x01DC, 0x00000000, 0xFFFFFFFF, 0, "CR_H264COMP16X16_RECON_CRC" } ,\
	{0x01E0, 0x155AAEAB, 0x3FFFFFFF, 0, "CR_H264COMP_ROUND_0" } ,\
	{0x01E4, 0x000AAEAB, 0x000FFFFF, 0, "CR_H264COMP_ROUND_1" } ,\
	{0x01E8, 0x00055555, 0x000FFFFF, 0, "CR_H264COMP_ROUND_2" } ,\
	{0x01EC, 0x00000000, 0x00000001, 0, "CR_H264COMP_ROUND_INIT" } ,\
	{0x01F0, 0x00000000, 0xFFFFFFFF, 0, "CR_H264COMP_VIDEO_CONF_CONTROL_0" } ,\
	{0x01F4, 0x00000000, 0x0FFFFFF3, 0, "CR_H264COMP_VIDEO_CONF_CONTROL_1" } ,\
	{0x01F8, 0x00000000, 0xFFFFFFFF, 1, "CR_H264COMP_VIDEO_CONF_STATUS_0" } ,\
	{0x01FC, 0x00000000, 0xFFFFFFFF, 1, "CR_H264COMP_VIDEO_CONF_STATUS_1" } ,\
	{0x0200, 0x00000000, 0x0007D37F, 0, "CR_IPE_CONTROL" } ,\
	{0x0204, 0x00000000, 0x00070007, 0, "CR_IPE_SEARCH_STATUS" } ,\
	{0x0208, 0x00000000, 0xFFFFFFFF, 0, "CR_IPE0_MB_COST" } ,\
	{0x020C, 0x00000000, 0xFFFFFFFF, 0, "CR_IPE1_MB_COST" } ,\
	{0x0240, 0x00000000, 0xFFFFFFFF, 0, "CR_IPE0_BESTMV_CRC" } ,\
	{0x0244, 0x00000000, 0xFFFFFFFF, 0, "CR_IPE1_BESTMV_CRC" } ,\
	{0x0248, 0x00000000, 0xFFFFFFFF, 0, "CR_IPE0_COSTS_CRC" } ,\
	{0x024C, 0x00000000, 0xFFFFFFFF, 0, "CR_IPE1_COSTS_CRC" } ,\
	{0x0250, 0x00000000, 0x00000001, 0, "CR_IPE_MB_PERFORMANCE_CLEAR" } ,\
	{0x0254, 0x00000000, 0xFFFFFFFF, 1, "CR_IPE_MB_PERFORMANCE_RESULT" } ,\
	{0x0258, 0x00000000, 0xFFFFFFFF, 1, "CR_IPE_MB_PERFORMANCE_MB_NUMBER" } ,\
	{0x0260, 0x00000000, 0x0001FFFF, 0, "CR_IPE_VECTOR_CLIPPING" } ,\
	{0x0270, 0x00008000, 0x00008000, 0, "CR_JMCOMP_CONTROL" } ,\
	{0x0278, 0x00000000, 0x00000FFF, 0, "CR_JMCOMP_JPEG_LUMA_PRED" } ,\
	{0x027C, 0x00000000, 0x0FFF0FFF, 0, "CR_JMCOMP_JPEG_CHROMA_PREDS" } ,\
	{0x0280, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_0" } ,\
	{0x0284, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_1" } ,\
	{0x0288, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_2" } ,\
	{0x028C, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_3" } ,\
	{0x0290, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_4" } ,\
	{0x0294, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_5" } ,\
	{0x0298, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_6" } ,\
	{0x029C, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_7" } ,\
	{0x02A0, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_8" } ,\
	{0x02A4, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_9" } ,\
	{0x02A8, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_10" } ,\
	{0x02AC, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_11" } ,\
	{0x02B0, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_12" } ,\
	{0x02B4, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_13" } ,\
	{0x02B8, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_14" } ,\
	{0x02BC, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_LUMA_QUANTISER_15" } ,\
	{0x02C0, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_0" } ,\
	{0x02C4, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_1" } ,\
	{0x02C8, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_2" } ,\
	{0x02CC, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_3" } ,\
	{0x02D0, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_4" } ,\
	{0x02D4, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_5" } ,\
	{0x02D8, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_6" } ,\
	{0x02DC, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_7" } ,\
	{0x02E0, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_8" } ,\
	{0x02E4, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_9" } ,\
	{0x02E8, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_10" } ,\
	{0x02EC, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_11" } ,\
	{0x02F0, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_12" } ,\
	{0x02F4, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_13" } ,\
	{0x02F8, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_14" } ,\
	{0x02FC, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CHROMA_QUANTISER_15" } ,\
	{0x0300, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CRC" } ,\
	{0x0304, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_VLC_CRC" } ,\
	{0x0308, 0x00000000, 0x0003FFFF, 1, "CR_JMCOMP_PERFORMANCE_0" } ,\
	{0x030C, 0x00000000, 0xFFFFFFFF, 1, "CR_JMCOMP_CRC_RDATA" } ,\
	{0x0310, 0x00000000, 0xFFFFFFFF, 1, "CR_JMCOMP_CRC_CARC" } ,\
	{0x0320, 0x00000000, 0x0000FFFF, 1, "CR_JMCOMP_PERFORMANCE_1" } ,\
	{0x0324, 0x00000000, 0x00000003, 0, "CR_JMCOMP_PERFORMANCE_2" } ,\
	{0x0330, 0x00000000, 0x0F3F003F, 0, "CR_JMCOMP_QP_VALUE" } ,\
	{0x0334, 0x0000000F, 0x0000000F, 0, "CR_JMCOMP_QSCALE_CHANGE" } ,\
	{0x0338, 0x00000000, 0x3F1F3F1F, 0, "CR_JMCOMP_CARC_CONTROL_0" } ,\
	{0x033C, 0x00000000, 0x03F7FFFF, 0, "CR_JMCOMP_CARC_CONTROL_1" } ,\
	{0x0340, 0x00000000, 0xFFFFFFFF, 0, "CR_JMCOMP_CARC_COEFF_TOTAL" } ,\
	{0x0344, 0x00000000, 0x0000001F, 0, "CR_SPE_ZERO_THRESH" } ,\
	{0x0348, 0x00000000, 0xFFFFFFFF, 0, "CR_SPE0_BEST_SAD_SIGNATURE" } ,\
	{0x034C, 0x00000000, 0xFFFFFFFF, 0, "CR_SPE1_BEST_SAD_SIGNATURE" } ,\
	{0x0350, 0x00000000, 0xFFFFFFFF, 0, "CR_SPE0_BEST_INDEX_SIGNATURE" } ,\
	{0x0354, 0x00000000, 0xFFFFFFFF, 0, "CR_SPE1_BEST_INDEX_SIGNATURE" } ,\
	{0x0358, 0x00000000, 0xFFFFFFFF, 0, "CR_SPE_INTRA_COST_SIGNATURE" } ,\
	{0x0360, 0x0003CFC2, 0x80FFFFFF, 0, "CR_SPE_MVD_CLIP_RANGE" } ,\
	{0x0364, 0x00000000, 0x00000003, 0, "CR_SPE_SUBPEL_RESOLUTION" } ,\
	{0x0368, 0x00000000, 0xFFFFFFFF, 0, "CR_SPE0_MV_SIZE_SIGNATURE" } ,\
	{0x036C, 0x00000000, 0xFFFFFFFF, 0, "CR_SPE1_MV_SIZE_SIGNATURE" } ,\
	{0x0370, 0x00000000, 0xFFFFFFFF, 1, "CR_SPE_MB_PERFORMANCE_RESULT" } ,\
	{0x0374, 0x00000000, 0xFFFFFFFF, 1, "CR_SPE_MB_PERFORMANCE_MB_NUMBER" } ,\
	{0x0378, 0x00000000, 0x00000001, 0, "CR_SPE_MB_PERFORMANCE_CLEAR" } ,\
	{0x037C, 0x00000000, 0xFFFFFFFF, 0, "CR_PC_TOTAL_COSTS_SIGNATURE" } ,\
	{0x0380, 0x00000000, 0xFFFFFFFF, 0, "CR_PC_INTER_REGS_SIGNATURE" } ,\
	{0x0384, 0x00000000, 0xFFFFFFFF, 0, "CR_PC_INTRA_REGS_SIGNATURE" } ,\
	{0x0388, 0x00000000, 0xFFFFFFFF, 0, "CR_PC_HW_OUTPUT_SIGNATURE" } ,\
	{0x038C, 0x00000000, 0xFFFFFFFF, 0, "CR_PC_COSTS_16X8_SIGNATURE" } ,\
	{0x0390, 0x00000000, 0xFFFF3B17, 0, "CR_PRED_COMB_CONTROL" } ,\
	{0x0394, 0x00000000, 0xFFFFFFFF, 0, "CR_PC_COSTS_8X16_SIGNATURE" } ,\
	{0x0398, 0x00000000, 0xFFFFFFFF, 0, "CR_PC_COSTS_8X8_SIGNATURE" } ,\
	{0x039C, 0x00000000, 0x00000001, 0, "CR_PRED_BU_STAT_UPDATE" } ,\
	{0x03A0, 0x00000000, 0x7FFFFFFF, 0, "CR_BEST_INTER_BU_SAD" } ,\
	{0x03A4, 0x00000000, 0xFFFFFFFF, 0, "CR_BEST_INTER_BU_COST" } ,\
	{0x03A8, 0x00000000, 0x7FFFFFFF, 0, "CR_BEST_INTRA_BU_SAD" } ,\
	{0x03AC, 0x00000000, 0xFFFFFFFF, 0, "CR_BEST_INTRA_BU_COST" } ,\
	{0x03B0, 0x00000000, 0xFFFFFFFF, 0, "CR_PRED_COMB_DMS_SIGNATURE" } ,\
	{0x03B4, 0x00000000, 0x0000FFFF, 0, "CR_PC_DMS_PERFORMANCE_CYCLES" } ,\
	{0x03B8, 0x00000000, 0x0000FFFF, 0, "CR_PC_DMS_PERFORMANCE_MB_NUM" } ,\
	{0x03BC, 0x00000000, 0x00000003, 0, "CR_PC_DMS_PERFORMANCE_CTRL" } ,\
	{0x03C0, 0x00000000, 0x0000FFFF, 0, "CR_PC_DM_PERFORMANCE_CYCLES" } ,\
	{0x03C4, 0x00000000, 0x0000FFFF, 0, "CR_PC_DM_PERFORMANCE_MB_NUM" } ,\
	{0x03C8, 0x00000000, 0x00000003, 0, "CR_PC_DM_PERFORMANCE_CTRL" } ,\
	{0x03CC, 0x00000000, 0x0000FFFF, 0, "CR_BEST_INTER_INTRA_COUNTS" } ,\
	{0x03D0, 0x00000000, 0xC0000077, 0, "CR_WEIGHTED_PRED_CONTROL" } ,\
	{0x03D4, 0x00000000, 0xFFFFFFFF, 0, "CR_WEIGHTED_PRED_COEFFS_0" } ,\
	{0x03D8, 0x00000000, 0xFFFFFFFF, 0, "CR_WEIGHTED_PRED_COEFFS_1" } ,\
	{0x03DC, 0x00000000, 0xFFFFFFFF, 0, "CR_WEIGHTED_PRED_COEFFS_2" } ,\
	{0x03E0, 0x00000000, 0x003FFFFF, 0, "CR_WEIGHTED_PRED_INV_WEIGHT" } ,\
	{0x03F0, 0x00000000, 0xFFFFFFFF, 0, "CR_TOPAZHP_RSVD0" } ,\
	{0x03F4, 0x00000000, 0x000001FB, 0, "CR_TOPAZHP_CRC_CLEAR" } ,\
{ 0 }}

#define TOPAZHP_REGS_INIT(uBase) \
	{ \
		int n;\
		TOPAZHP_REG_DEFAULT_TABLE;\
		for (n = 0; n < sizeof(TOPAZHP_Defaults)/ sizeof(TOPAZHP_Defaults[0] ) -1; n++)\
		{\
			RegWriteNoTrap(TOPAZHP_Defaults[n].uRegOffset + uBase, TOPAZHP_Defaults[n].uRegDefault); \
		}\
	}
#endif
