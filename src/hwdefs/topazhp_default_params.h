/******************************************************************************
 ...
 @File         topazhp_default_params.h

 @Title        Default commandline values for Test IL Client/Test Application

 @Copyright    Copyright (C) 2006 - 2011 by Imagination Technologies Limited.

 @Platform     Generic

 @Description  Defines macros that contains default values for test parameters (TEST_PARAMS).
				To be shared between OMX components and test apps. 
