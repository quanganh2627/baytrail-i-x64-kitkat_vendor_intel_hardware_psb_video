/*
	Register defines for TOPAZ_VLC_
	Command line: -chipname TOPAZ_VLC C:/work/TopazHP/3.4_Build151/sim/topaz/topaz_reg_defs/topazhp_vlc_regs.def -simout topaz_vlc_regs.h
	Generated by regconv version 1.158, from files:
	topazhp_vlc_regs.def 
*/
