/*
	Register defines for TOPAZ_DB_
	Command line: -chipname TOPAZ_DB C:/work/TopazHP/3.4_Build151/sim/topaz/topaz_reg_defs/topazhp_db_regs.def -simout topaz_db_regs.h
