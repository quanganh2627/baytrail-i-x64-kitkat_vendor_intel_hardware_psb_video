...
img_void iep_lite_RenderCompleteCallback ( img_void )
{
	...
	{			
		...
		else
		{
			...
			READ_REGISTER ( IEP_LITE_BLE_MAV_OFFSET,
							ui32MyReg	);
		...
		{
			iep_lite_CalculateBLELookUpTable (	sIEP_LITE_Context.i32YMinIn,
												sIEP_LITE_Context.i32YMaxIn	);								
		
			/* All ready for writing to hardware */
			iep_lite_WriteBLELUTToHardware ( );																
		}			
	}
											...
											img_int32	i32YMaxIn	)
{
	...
	IMG_MEMSET (aui32BLELUT, 0, sizeof(img_uint32)*(ui32resolution));
	/*----------------------------------------------------------------------------*/
	for(ui32i = ui32x4; ui32i < ui32resolution; ui32i++)
	{
		aui32BLELUT [ui32i] = IEP_LITE_DATA_SIZE_10_BITS;
	}
	
	aui32BLELUT [ui32x1] = ui32y1;
	aui32BLELUT [ui32x2] = ui32y2;
	aui32BLELUT [ui32x3] = ui32y3;
	aui32BLELUT [ui32x4] = ui32y4;

	iep_lite_BLERecursiveLUTCalculation ( ui32x1, 
										  aui32BLELUT[ui32x1], 
										  ui32x2, 
										  aui32BLELUT[ui32x2], 
										  ui32x3, 
 ...
 *****************************************************************************/
img_void iep_lite_BLERecursiveLUTCalculation ( img_int32 i32x1, img_int32 i32y1, img_int32 i32x2, img_int32 i32y2, img_int32 i32x3, img_int32 i32y3, img_int32 i32x4, img_int32 i32y4 )
{
	img_uint32 ui32id1; 
	img_uint32 ui32id2; 
	img_uint32 ui32id3; 
	...
	{		
		...
		aui32BLELUT[ui32id1] = i32y1;
		aui32BLELUT[ui32id2] = (i32y1 + i32y2) >> 1;
		aui32BLELUT[ui32id3] = (aui32BLELUT[ui32id2] >> 1) + ((i32y2 + i32y3) >> 2);
		aui32BLELUT[ui32id7] = (i32y3 + i32y4) >> 1;
		aui32BLELUT[ui32id8] = i32y4;
		aui32BLELUT[ui32id6] = ((i32y2 + i32y3) >> 2) + (aui32BLELUT[ui32id7] >> 1);
		aui32BLELUT[ui32id4] = aui32BLELUT[ui32id5] = ((aui32BLELUT[ui32id3] + aui32BLELUT[ui32id6]) >> 1);

		iep_lite_BLERecursiveLUTCalculation (ui32id1, aui32BLELUT[ui32id1], ui32id2, aui32BLELUT[ui32id2], ui32id3, aui32BLELUT[ui32id3], ui32id4, aui32BLELUT[ui32id4]);
		iep_lite_BLERecursiveLUTCalculation (ui32id5, aui32BLELUT[ui32id5], ui32id6, aui32BLELUT[ui32id6], ui32id7, aui32BLELUT[ui32id7], ui32id8, aui32BLELUT[ui32id8]);
	}
