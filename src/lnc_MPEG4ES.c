...
struct format_vtable_s lnc_MPEG4ES_vtable = {
  queryConfigAttributes: lnc_MPEG4ES_QueryConfigAttributes,
  validateConfig: lnc_MPEG4ES_ValidateConfig,
  createContext: lnc_MPEG4ES_CreateContext,
  destroyContext: lnc_MPEG4ES_DestroyContext,
  beginPicture: lnc_MPEG4ES_BeginPicture,
  renderPicture: lnc_MPEG4ES_RenderPicture,
  endPicture: lnc_MPEG4ES_EndPicture
};
