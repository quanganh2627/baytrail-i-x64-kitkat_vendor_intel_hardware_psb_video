...
static void ptg_H263ES_QueryConfigAttributes(
    VAProfile profile,
...
static VAStatus ptg_H263ES_ValidateConfig(
...
static VAStatus ptg_H263ES_CreateContext(
...
static void ptg_H263ES_DestroyContext(
    object_context_p obj_context)
{
    drv_debug_msg(VIDEO_DEBUG_GENERAL, "%s\n", __FUNCTION__);
...
static VAStatus ptg_H263ES_BeginPicture(
    object_context_p obj_context)
{
    INIT_CONTEXT_H263ES;
...
static VAStatus ptg__H263ES_process_sequence_param(context_ENC_p ctx, object_buffer_p obj_buffer)
{
    context_ENC_mem *ps_mem = &(ctx->ctx_mem[ctx->ui32StreamID]);
...
static VAStatus ptg__H263ES_process_picture_param(context_ENC_p ctx, object_buffer_p obj_buffer)
{
    VAStatus vaStatus = VA_STATUS_SUCCESS;
    context_ENC_mem *ps_mem = &(ctx->ctx_mem[ctx->ui32StreamID]);
...
static VAStatus ptg__H263ES_process_slice_param(context_ENC_p ctx, object_buffer_p obj_buffer)
{
    VAStatus vaStatus = VA_STATUS_SUCCESS;
...
static VAStatus ptg__H263ES_process_misc_param(context_ENC_p ctx, object_buffer_p obj_buffer)
{
    VAStatus vaStatus = VA_STATUS_SUCCESS;
...
static VAStatus ptg_H263ES_RenderPicture(
    object_context_p obj_context,
    ...
    int num_buffers)
{
    ...
    drv_debug_msg(VIDEO_DEBUG_GENERAL, "ptg_H263ES_RenderPicture\n");
    for (i = 0; i < num_buffers; i++) {
        object_buffer_p obj_buffer = buffers[i];

        switch (obj_buffer->type) {
        case VAEncSequenceParameterBufferType:
            drv_debug_msg(VIDEO_DEBUG_GENERAL, "ptg_H263_RenderPicture got VAEncSequenceParameterBufferType\n");
            vaStatus = ptg__H263ES_process_sequence_param(ctx, obj_buffer);
            DEBUG_FAILURE;
            break;
        case VAEncPictureParameterBufferType:
            drv_debug_msg(VIDEO_DEBUG_GENERAL, "ptg_H263_RenderPicture got VAEncPictureParameterBuffer\n");
            vaStatus = ptg__H263ES_process_picture_param(ctx, obj_buffer);
            DEBUG_FAILURE;
            break;

        case VAEncSliceParameterBufferType:
            drv_debug_msg(VIDEO_DEBUG_GENERAL, "ptg_H263_RenderPicture got VAEncSliceParameterBufferType\n");
            vaStatus = ptg__H263ES_process_slice_param(ctx, obj_buffer);
            DEBUG_FAILURE;
            break;

        case VAEncMiscParameterBufferType:
            drv_debug_msg(VIDEO_DEBUG_GENERAL, "ptg_H263_RenderPicture got VAEncMiscParameterBufferType\n");
            vaStatus = ptg__H263ES_process_misc_param(ctx, obj_buffer);
            DEBUG_FAILURE;
            break;
        default:
            vaStatus = VA_STATUS_ERROR_UNKNOWN;
...
static VAStatus ptg_H263ES_EndPicture(
    object_context_p obj_context)
{
    INIT_CONTEXT_H263ES;
    VAStatus vaStatus = VA_STATUS_SUCCESS;
...
struct format_vtable_s ptg_H263ES_vtable = {
queryConfigAttributes:
    ptg_H263ES_QueryConfigAttributes,
validateConfig:
    ptg_H263ES_ValidateConfig,
createContext:
    ptg_H263ES_CreateContext,
destroyContext:
    ptg_H263ES_DestroyContext,
beginPicture:
    ptg_H263ES_BeginPicture,
renderPicture:
    ptg_H263ES_RenderPicture,
endPicture:
    ptg_H263ES_EndPicture
};
